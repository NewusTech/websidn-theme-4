    ...
    <nav class="navbar navbar-expand-lg bg-white navbar-light sticky-top p-0">
        ...
        <div class="collapse navbar-collapse justify-content-center" id="navbarCollapse">
            <div class="navbar-nav p-4 p-lg-0 justify-content-center">
                ...
                <a href="/portofolio" class="nav-item nav-link active fs-6">Portofolio</a>
    ...
    <div class="container-xxl py-3">
        <div class="container">
            <div class="section-title text-center">
                <h1 class="display-5 mb-5">Portofolio</h1>
            </div>
                ...
                <div class="col-lg-4 col-md-6 portfolio-item first wow fadeInUp" data-wow-delay="0.1s">
                    <div class="rounded overflow-hidden">
                        <div class="position-relative overflow-hidden">
                            <img class="img-fluid w-100" src="{{ Storage::disk('s3')->url($portofolios->image) }}" alt="">
                        </div>
                        <div class="border border-5 border-light border-top-0 p-4" >
                            <h4 class="text-primary fw-medium mb-2">{{ $portofolios->judul }}</h4>
                            <p class="lh-base mb-2 ">{{ $portofolios->detail }}</p>
                            <a href="/document-portofolio" class="btn btn-primary w-100 rounded my-2">Lihat Project</a>
                        </div>
                    </div>
                </div>
                @endforeach
