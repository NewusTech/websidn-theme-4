    ...
    <nav class="navbar navbar-expand-lg bg-white navbar-light sticky-top p-0">
        ...
        <div class="collapse navbar-collapse justify-content-center" id="navbarCollapse">
            <div class="navbar-nav p-4 p-lg-0 justify-content-center">
                ...
                <a href="/galleri" class="nav-item nav-link active fs-6">Galeri</a>
            ...
            <div class="row mt-n2 wow fadeInUp" data-wow-delay="0.3s">
                <div class="col-12 text-center">
                    <ul class="list-inline mb-5" id="portfolio-flters">
                        ...
                        <li class="mx-2" data-filter=".Wedding">Wedding Decor</li>
                        <li class="mx-2" data-filter=".Event">Event Decor</li>
                        <li class="mx-2" data-filter=".Interior">Interior Decor</li>
                    </ul>
                </div>
            </div>
