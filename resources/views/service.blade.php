    ...
    <nav class="navbar navbar-expand-lg bg-white navbar-light sticky-top p-0">
        ...
        <div class="collapse navbar-collapse justify-content-center" id="navbarCollapse">
            <div class="navbar-nav p-4 p-lg-0 justify-content-center">
                ...
                <a href="layanan" class="nav-item nav-link active fs-6">Layanan</a>
                ...
                <div class="col-md-6 col-lg-4 wow fadeInUp" data-wow-delay="0.1s">
                    <div class="service-item">
                        ...
                        <div class="p-4 text-center border border-5 border-light border-top-0">
                            ...
                            <p>{{ $layanan->detail }}</p>
                            <a class="fw-medium" href="/document-brosur" >Read More<i class="fa fa-arrow-right ms-2"></i></a>
                        </div>
                    </div>
                </div>
                @endforeach
        ...
        <div class="container feature py-3">
            ...
            <div class="card-container">
                ...
                <div class="price-card">
                    ...
                    <a href="/document-price" class="read-more-btn">See More</a>
                </div>
                @endforeach
